...
# External files
PACKAGES_SCRIPT="https://raw.githubusercontent.com/netend/demo/master/sh/install-required-packages.sh"
...
warning() {
	...
	if [ "${INTERACTIVE}" = "0" ]; then
		...
		#read -r -p "Press ENTER to attempt netdata installation > " #aoye
